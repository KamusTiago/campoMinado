...
const congratulationsWinner = board => fields(board).filter(pending).length === 0
...
export {createMinedBoard, cloneBoard, openField, hadExplosion, congratulationsWinner, showMines, invertFlag, flagsUsed}